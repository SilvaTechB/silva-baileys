...
const SilvaStatus = require("./gcstatus");
...
const makeMessagesSocket = (config) => {
    ...
    const silvaStatus = new SilvaStatus(Utils_1, waUploadToServer, relayMessage, config, sock);
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (
                ...
                return await silvaStatus.handleGroupStory(content, jid, options.quoted);
            } else {
